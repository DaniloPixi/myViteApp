 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Pn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Pn(t){return t.getComponent()?.type==="VERSION"}const ce="@firebase/app",Ne="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w=new Cn("@firebase/app"),Bn="@firebase/app-compat",$n="@firebase/analytics-compat",xn="@firebase/analytics",Un="@firebase/app-check-compat",Fn="@firebase/app-check",Hn="@firebase/auth",Kn="@firebase/auth-compat",jn="@firebase/database",Vn="@firebase/data-connect",qn="@firebase/database-compat",Wn="@firebase/functions",zn="@firebase/functions-compat",Gn="@firebase/installations",Jn="@firebase/installations-compat",Yn="@firebase/messaging",Xn="@firebase/messaging-compat",Qn="@firebase/performance",Zn="@firebase/performance-compat",er="@firebase/remote-config",tr="@firebase/remote-config-compat",nr="@firebase/storage",rr="@firebase/storage-compat",sr="@firebase/firestore",ir="@firebase/ai",ar="@firebase/firestore-compat",or="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const le="[DEFAULT]",cr={[ce]:"fire-core",[Bn]:"fire-core-compat",[xn]:"fire-analytics",[$n]:"fire-analytics-compat",[Fn]:"fire-app-check",[Un]:"fire-app-check-compat",[Hn]:"fire-auth",[Kn]:"fire-auth-compat",[jn]:"fire-rtdb",[Vn]:"fire-data-connect",[qn]:"fire-rtdb-compat",[Wn]:"fire-fn",[zn]:"fire-fn-compat",[Gn]:"fire-iid",[Jn]:"fire-iid-compat",[Yn]:"fire-fcm",[Xn]:"fire-fcm-compat",[Qn]:"fire-perf",[Zn]:"fire-perf-compat",[er]:"fire-rc",[tr]:"fire-rc-compat",[nr]:"fire-gcs",[rr]:"fire-gcs-compat",[sr]:"fire-fst",[ar]:"fire-fst-compat",[ir]:"fire-vertex","fire-js":"fire-js",[or]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Er(t){v(new T("platform-logger",e=>new Ln(e),"PRIVATE")),v(new T("heartbeat",e=>new wr(e),"PRIVATE")),D(ce,Ne,t),D(ce,Ne,"esm2020"),D("fire-js","")}Er("");var Cr="firebase",Sr="12.2.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt=1e4,st=`w:${ge}`,it="FIS_v2",Tr="https://firebaseinstallations.googleapis.com/v1",Ar=3600*1e3,Rr="installations",kr="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt=new Map;function pt(t,e){const n=q(t);gt(n,e),xr(n,e)}function gt(t,e){const n=dt.get(t);if(n)for(const r of n)r(e)}function xr(t,e){const n=Ur();n&&n.postMessage({key:t,fid:e}),Fr()}let S=null;function Ur(){return!S&&"BroadcastChannel"in self&&(S=new BroadcastChannel("[Firebase] FID Change"),S.onmessage=t=>{gt(t.data.key,t.data.fid)}),S}function Fr(){dt.size===0&&S&&(S.close(),S=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ls(t){return new Promise(e=>{setTimeout(e,t)})}async function Ps(t,e){const n=Bs(e,await t.firebaseDependencies.installations.getId());$s(t,n,e.productId)}function Bs(t,e){const n={};return t.from&&(n.project_number=t.from),t.fcmMessageId&&(n.message_id=t.fcmMessageId),n.instance_id=e,t.notification?n.message_type=H.DISPLAY_NOTIFICATION.toString():n.message_type=H.DATA_MESSAGE.toString(),n.sdk_platform=fs.toString(),n.package_name=self.origin.replace(/(^\w+:|^)\/\//,""),t.collapse_key&&(n.collapse_key=t.collapse_key),n.event=ds.toString(),t.fcmOptions?.analytics_label&&(n.analytics_label=t.fcmOptions?.analytics_label),n}function $s(t,e,n){const r={};r.event_time_ms=Math.floor(Date.now()).toString(),r.source_extension_json_proto3=JSON.stringify({messaging_client_event:e}),n&&(r.compliance_data=xs(n)),t.logEvents.push(r)}function xs(t){return{privacy_context:{prequest:{origin_associated_product_id:t}}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xs=t=>{const e=new Ys(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return self.addEventListener("push",n=>{n.waitUntil(Fs(n,e))}),self.addEventListener("pushsubscriptionchange",n=>{n.waitUntil(Us(n,e))}),self.addEventListener("notificationclick",n=>{n.waitUntil(Hs(n))}),e};function Qs(){v(new T("messaging-sw",Xs,"PUBLIC"))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qs();const ri={apiKey:"AIzaSyAGxR--Jx9ELN6IZ5hb1sCD67vreCJqm-k",authDomain:"gruandus.firebaseapp.com",projectId:"gruandus",storageBucket:"gruandus.firebasestorage.app",messagingSenderId:"104287336044",appId:"1:104287336044:web:c2065e0f2f6fb15ff64a49"},si=Ze(ri),ii=ti(si);Zt([{"revision":null,"url":"assets/index-D2ciSxal.js"},{"revision":null,"url":"assets/index-DK6BLyzP.css"},{"revision":"9ee9de55ff01aaf007e5d6bf9e13c222","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"1f46f398a657102938db5d1ef20f966f","url":"manifest-icon-192.maskable.png"},{"revision":"38d9e11f1da111aa43028dd72b45ea38","url":"manifest-icon-512.maskable.png"},{"revision":"77abb68d1b41c391b9b693cf61cdddf1","url":"manifest.webmanifest"}]||[]);ni(ii,t=>{console.log("[sw.js] Received background message",t);const e=t.notification.title,n={body:t.notification.body,icon:"/manifest-icon-192.maskable.png"};self.registration.showNotification(e,n)});
